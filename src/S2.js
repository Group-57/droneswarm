   ...
   // This should log on every map click
    ...
    return(
        ...
        <div className="total" >
            ...
            <div className="head1">
            <h3 >Please Mark The Geofence</h3>
            </div>
            
            <LoadScript googleMapsApiKey="AIzaSyBayGa632VtUDZpprU6oEEttopY7K7UEZg">
      <GoogleMap
...
<br></br>
                ...
                <div className="contains"   style={{ backgroundImage: `url(${drone1})` }}>
                <input 
        type="number" 
